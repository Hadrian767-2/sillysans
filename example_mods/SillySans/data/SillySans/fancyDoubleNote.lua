...
XML_l = 'leftalt instance 1' 		-- Left Sing
XML_d = 'downalt instance 1' 		-- Down Sing
XML_u = 'upalt instance 1' 			-- Up Sing
XML_r = 'rightalt instance 1' 		-- Right Sing
...
lOs = {'71', '102'}		-- Left Sing
dOs = {'75', '73'}	-- Down Sing
uOs = {'-71', '122'}		-- Up Sing
rOs = {'-95', '77'}		-- Right Sing	
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
    if (noteType == doubleNoteName) then
		...
		runTimer('ghostSingsbf', ghostDelay)
